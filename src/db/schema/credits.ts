...
export const creditTransactions = pgTable("credit_transactions", {
  ...
  userId: text("userId").references(() => users.id, { onDelete: "cascade" }), // User ID buying the credits

  organizationId: text("organizationId")
    .notNull()
    .references(() => organizations.id, { onDelete: "cascade" }), // Organization ID for organization-wide credits
