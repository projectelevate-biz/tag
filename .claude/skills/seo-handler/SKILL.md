...
5.  **Robots Control**: Use `src/app/robots.ts` to guide crawlers. **CRITICAL**: Disallow private app routes.
...
Ensure you disallow private routes (`/api/`, `/app/`, `/super-admin/`) to save crawl budget and protect privacy.
